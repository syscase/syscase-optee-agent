...
parse_handler_t get_parse_handler(unsigned char type)
{
  switch(type) {
    ...
    case ARG_FILE: return parse_argument_file;
    case ARG_FD: return parse_argument_fd;
    case ARG_VECTOR_64: return parse_argument_vector_64;
    case ARG_FILENAME: return parse_argument_filename;
    case ARG_PID: return parse_argument_pid;
